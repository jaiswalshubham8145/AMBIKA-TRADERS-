          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="w-full flex items-center justify-center gap-2 bg-primary text-primary-foreground py-3 rounded-md text-xs font-semibold hover:bg-primary/90 transition-colors shadow-sm"
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-9 pr-3 py-2.5 bg-background border border-input rounded-md text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                />
              </div>
            </div>
